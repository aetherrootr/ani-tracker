    ...
    try:
        with session_factory() as session:
            rows = session.execute(
                ...
                .where(AnimeMetaInfo.provider_type == 'tvdb', UserAnimeProgress.anime_id.not_in(_matched_related_anime_ids('tvdb')))
        ...
        with session_factory() as session:
            rows = session.execute(
                ...
                .where(
                    ...
                    UserAnimeProgress.anime_id.not_in(_matched_related_anime_ids('tvdb')),
                )
